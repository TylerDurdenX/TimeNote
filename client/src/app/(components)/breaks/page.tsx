        ...
        <Tabs defaultValue="breaks" className="w-full">
          ...
          <TabsContent value="createBreak">
            <Card>
                   ...
                   <div className="grid gap-4 py-1">
                     <div className="grid grid-cols-8 items-center gap-4 mr-1">
                       ...
                       <Input
                         ...
                         required
                       />
                       <Label className="text-center">Break Code<span className="text-red-500 ml-1">*</span></Label>
                       <Input
                         value={breakCode}
              ...
              <CardFooter >
                <Button type="submit"  disabled={!isFormValid() || isLoading}>Create Break</Button>
              </CardFooter>
              </form>
            </Card>
          </TabsContent>
