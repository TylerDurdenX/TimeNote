...
<Card className="h-[39vh]">
  ...
  <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6 overflow-hidden">
    {/* Debugging: Check if filteredData has values */}
    {filteredData && filteredData.length > 0 ? (
      <ChartContainer
        config={chartConfig}
        className="w-full h-full max-h-[300px] mx-auto aspect-auto"
      >
      ...
      <p>No data available</p> // Show a fallback message if data is empty
    )}
  </CardContent>
</Card>
