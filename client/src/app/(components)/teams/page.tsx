...
const page = () => {
  ...
  const [createTeam, {isLoading: isLoadingCreateTeam}] = useCreateTeamMutation()

  const {data} = useGetTeamLeadsQuery({email: userEmail!}, {refetchOnMountOrArgChange: true})
        ...
        <Tabs defaultValue="teams" className="w-full">
          ...
          <TabsContent value="createTeam">
            <Card>
              ...
              <CardContent className="space-y-2">
                   <div className="grid gap-4 py-1">
                     <div className="grid grid-cols-8 items-center gap-4 mr-1">
                       <Label className="text-center">Team Name<span className="text-red-500 ml-1">*</span></Label>
                       <Input
                         value={teamName}
                         ...
                         required
                       />
                       <Label className="text-center">Team Description<span className="text-red-500 ml-1">*</span></Label>
                       <textarea
                       ...
                       ></textarea>
                       <Label className="text-center">TeamLeader<span className="text-red-500 ml-1">*</span></Label>
                         <Select
                           value={teamLeadEmail}
              ...
              <CardFooter >
                <Button type="submit"  disabled={!isFormValid() || isLoadingCreateTeam}>Create Team</Button>
              </CardFooter>
              </form>
            </Card>
          </TabsContent>
