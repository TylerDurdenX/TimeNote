...
export function AttendanceChart( {email, title, setOnTimeList, setLateArrivalList} : Props) {

  localStorage.removeItem('persist:root')

   const {data, isLoading} = useGetAttendanceLineChartDataQuery({email, title}, {refetchOnMountOrArgChange: true})
  ...
  <CardContent className=""> {/* Remove padding if you want the chart to fill the entire card */}
