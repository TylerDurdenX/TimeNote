...
export function CreateRole() {
  ...
  const isFormValid = () => {
    return name && code && description && selectedAuthorities.length>0 && !data?.flag
}
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[650px]">
        ...
        <DialogFooter>
          <button
            type='submit' className={`flex w-200px mt-4 justify-center bg-blue-600 rounded-md border border-transparent bg-blue-primary px-4 py-2 text-base font-medium text-white shadow-sm 
