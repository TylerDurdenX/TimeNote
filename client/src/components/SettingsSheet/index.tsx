          ...
          <div className="flex gap-1">
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <button className="w-44 py-2 bg-blue-800 text-white rounded-lg shadow-lg hover:bg-blue-600 transform transition duration-300 ease-in-out hover:scale-105 focus:outline-none">
                  Remove Picture
                </button>
              </AlertDialogTrigger>
              <AlertDialogContent>
